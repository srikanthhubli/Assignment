...
do
  ...
  args="{\"Args\":[\"AddData\",$docType,$BatchId, \"$FarmersId\",\"$aLogisticsId\",\"$ProductId\",\"$ProductName\",\"$Quantity\",\"$DateOfDispatch\",\"$DateOfArrival\",\"$PlaceOfArrival\"]}"
