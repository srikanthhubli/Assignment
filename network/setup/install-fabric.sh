...
HOSTNAME=farmersorg-peer1.farmersorg.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=logistics-peer1.logistics.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=srienterprices-peer1.srienterprices.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=priceauthority-peer1.priceauthority.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=orderer.farmersorg.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=postgresql
removehost $HOSTNAME            &> /dev/null
